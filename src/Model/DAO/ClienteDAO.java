...
public class ClienteDAO {
     ...
     */
    public void insert(CadastrarCliente cliente){
     ...
     * @return 
     */
    public boolean update(CadastrarCliente cliente){
     ...
     * @return 
     */
    public boolean delete(CadastrarCliente cliente){
        for (CadastrarCliente clienteLista : Banco.cliente) {
     ...
     */
    public ArrayList<CadastrarCliente> selectAll(){
     ...
     */
    private boolean idSaoIguais(CadastrarCliente cliente, CadastrarCliente clienteAComparar) {
